    ...
    <div class="form__header">
      ...
      <AppBtn @click="onCloseBtnClick" class="form__btn-close">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24">
          <path fill="#2c3e50" d="M19.7 4.3c-0.4-0.4-1-0.4-1.4 0l-6 6-6-6c-0.4-0.4-1-0.4-1.4 0s-0.4
            1 0 1.4l6 6-6 6c-0.4 0.4-0.4 1 0 1.4 0.4 0.4 1 0.4 1.4 0l6-6 6 6c0.4 0.4 1 0.4 1.4
            0s0.4-1 0-1.4l-6-6 6-6c0.4-0.4 0.4-1 0-1.4z" />
        </svg>
      </AppBtn>
    </div>
    <div class="form__item form-item">
      <label for="name" class="form-item__label">Имя</label>
      <input v-model="nameValue" type="text" id="name" class="form-item__data">
    </div>
    <div class="form__item form-item">
